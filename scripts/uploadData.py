...
event_year_file = 'ND_Events_12_months.csv'
...
# upload_csv(event_path, event_speed_file, event_speed_order, event_speed_header, EventSpeed, chuck_upload=True, needs_id=False)
upload_csv(event_path, event_year_file, event_speed_order, event_speed_header, EventYear, chuck_upload=True, needs_id=False)
